    ...
    class LazySpecializedKernel(CCompiler.LazySpecializedKernel):
        ...
        def transform(self, tree, program_config):
            ...
            for i, (target, i_space, stencil_node) in enumerate(
                ...
                sub.body.append(StringTemplate('printf("i0 %d, i1 %d, dst %d src0 %d src1 %d\\n", index_0, index_1, encode6_6(index_0, index_1), encode6_6(index_0 + 2, index_1 + 0), encode6_6(index_0 + 1, index_1 + 0) );'))
                sub.body.append(
                    StringTemplate('printf("i0 %d, i1 %d, dst %f src0 %f src1 %f\\n"' +
                                   ', index_0, index_1, mesh[encode6_6(index_0, index_1)], mesh[encode6_6(index_0 + 2, index_1 + 0)], mesh[encode6_6(index_0 + 1, index_1 + 0)] );'))
